            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px]">
              ...
              <div className="p-10 flex flex-col">
                ...
                <div className="flex gap-2.5 flex-wrap mt-auto">
                  <Link href="/contact" className="btn-primary text-[13px] !px-4 !py-2.5">
                    Explore Steward Demo <ArrowIcon />
                  </Link>
                  <Link href="/projects#steward-heading" className="btn-ghost text-[13px] !px-4 !py-2.5">
                    Learn more
                  </Link>
                </div>
              </div>
            ...
            <FadeIn key={p.title} delay={i * 0.1}>
              <article className="card-surface overflow-hidden flex flex-col h-full group">
                ...
                <div className="p-6 flex flex-col gap-2.5 flex-1">
                  ...
                  <Link href={p.href} className="inline-flex items-center gap-1.5 text-[12px] font-semibold font-mono group-hover:gap-2.5 transition-all mt-1"
                    style={{ color: 'var(--accent)' }}>
      ...
      <div className="max-w-[1160px] mx-auto px-7">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[240px_1fr_1fr_1fr_1fr] gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 font-bold text-[15px] tracking-[-0.02em] text-[var(--text-1)]">
            ...
            <div key={col.title}>
              ...
              <ul className="flex flex-col gap-2.5">
                {col.links.map(([label, href]) => (
                  <li key={label}>
                    {href.startsWith('/') ? (
                      <Link href={href} className="text-[13px] transition-colors duration-200"
